...
// Modify SmokePuff component to follow the plane's movement pattern
const SmokePuff = ({
  progress,
  puffProgress,
}: {
  ...
  // Calculate x and y positions based on the plane's position at the time the puff was created
  const x = useTransform(
    useMotionValue(puffProgress),
    (v) => `${-80 + 590 * v}%`
  );
  ...
  return (
    <motion.div
      className="absolute w-2 h-2 rounded-full bg-gray-200 dark:bg-gray-600"
      style={{ x, y }}
...
export default function SimpleBirds() {
  // Create a motion value that goes from 0 to 1.
  ...
  // 0 at progress=0, 1 at progress=0.1, remain 1 until 0.9, then back to 0 at progress=1.
  const opacityValue = useTransform(progress, [0, 0.1, 0.9, 1], [0, 1, 1, 0]);

  // Animate the progress value from 0 to 1 continuously.
  useEffect(() => {
    // Delay initial animation by 2 seconds
    const initialTimeout = setTimeout(() => {
      const controls = animate(progress, 1, {
        duration: 6,
        ease: "linear",
        repeat: Infinity,
        repeatDelay: 10, // Increased from 1 to 15 seconds
      });
  ...
  return (
    <>
      ...
      >
        <path
          style={{ fill: "#E8E8E8" }}
          d="M462.932,273.761L462.932,273.761c-25.11,0-48.931-11.126-65.045-30.384l0,0
        ...
        <path
          style={{ fill: "#E8E8E8" }}
          d="M512,322.829L512,322.829c0,25.388-20.581,45.968-45.968,45.968H171.671
        ...
        <path
          style={{ fill: "#333E48" }}
          d="M397.887,243.377c-0.542-0.648-1.112-1.267-1.675-1.893h-53.554c-8.809,0-15.95,7.141-15.95,15.95
          c0,8.809,7.141,15.95,15.95,15.95h112.367C432.875,271.311,412.299,260.6,397.887,243.377z"
        />
        <path
          style={{ fill: "#7fe7d1" }} // Updated from "#6DABE4" to Writing button green
          d="M69.051,137.555c-5.135-12.908-17.622-21.38-31.514-21.38H19.803C8.866,116.175,0,125.041,0,135.978
        ...
        <path
          ...
          d="M483.254,347.48H188.893c-94.812,0-171.671-76.859-171.671-171.671v-59.447
        ...
        <g>
          <path
            style={{ fill: "#333E48" }}
            d="M264.972,273.385h7.557c5.285,0,9.57-4.285,9.57-9.57v-12.76c0-5.285-4.285-9.57-9.57-9.57h-7.557
              c-5.285,0-9.57,4.285-9.57,9.57v12.76C255.403,269.1,259.687,273.385,264.972,273.385z"
          />
          <path
            style={{ fill: "#333E48" }}
            d="M204.171,273.385h7.557c5.285,0,9.57-4.285,9.57-9.57v-12.76c0-5.285-4.285-9.57-9.57-9.57h-7.557
              c-5.285,0-9.57,4.285-9.57,9.57v12.76C194.6,269.1,198.885,273.385,204.171,273.385z"
          />
          <path
            style={{ fill: "#333E48" }}
            d="M143.369,273.385h7.557c5.285,0,9.57-4.285,9.57-9.57v-12.76c0-5.285-4.285-9.57-9.57-9.57h-7.557
              c-5.285,0-9.57,4.285-9.57,9.57v12.76C133.799,269.1,138.083,273.385,143.369,273.385z"
          />
          <path
            style={{ fill: "#333E48" }}
            d="M82.566,273.385h7.557c5.285,0,9.57-4.285,9.57-9.57v-12.76c0-5.285-4.285-9.57-9.57-9.57h-7.557
              c-5.285,0-9.57,4.285-9.57,9.57v12.76C72.997,269.1,77.282,273.385,82.566,273.385z"
          />
        </g>
        <path
          style={{ fill: "#7fe7d1" }}
          d="M246.26,341.636h-49.655c-7.936,0-14.37,6.434-14.37,14.37v25.444c0,7.936,6.434,14.37,14.37,14.37
          h49.655c7.787,0,14.1-6.313,14.1-14.1v-25.982C260.36,347.949,254.047,341.636,246.26,341.636z"
        />
        <g style={{ opacity: 0.15 }}>
          <path
            d="M256.887,387.248H207.23c-7.936,0-14.37-6.434-14.37-14.37v-25.444c0-1.966,0.397-3.84,1.112-5.547
        ...
        <path
          style={{ fill: "#FFFFFF" }}
          d="M264.864,303.405H177.73c-10.557,0-19.115,8.559-19.115,19.115l0,0
        ...
        <path
          ...
          d="M274.179,333.066h-87.134c-10.557,0-19.115-8.559-19.115-19.115
